...
#include "../../../../../TesteDeNovo/menuprincipal.h"
...
static constexpr auto qt_meta_stringdata_ZN13MenuPrincipalE = QtMocHelpers::stringData(
    "MenuPrincipal",
    "voltarLogin",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MenuPrincipalE[] = {
...
Q_CONSTINIT const QMetaObject MenuPrincipal::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MenuPrincipalE.offsetsAndSizes,
    qt_meta_data_ZN13MenuPrincipalE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MenuPrincipalE_t,
        // Q_OBJECT / Q_GADGET
...
void *MenuPrincipal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MenuPrincipalE.stringdata0))
